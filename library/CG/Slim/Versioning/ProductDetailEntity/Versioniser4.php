...
class Versioniser4 implements VersioniserInterface
{
    ...
    public function upgradeRequest(array $params, Hal $request)
    {
        ...
        if (!isset($data['id']) || isset($data['barcodeNotApplicable'])) {
            return;
        }
        ...
        if (!isset($data['barcodeNotApplicable'])) {
            $data['barcodeNotApplicable'] = $productDetail->isBarcodeNotApplicable();
        }
    ...
    public function downgradeResponse(array $params, Hal $response, $requestedVersion)
    {
        ...
        unset($data['barcodeNotApplicable']);

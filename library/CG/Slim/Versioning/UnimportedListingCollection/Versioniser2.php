...
use CG\Slim\Versioning\UnimportedListingEntity\Versioniser2 as UnimportedListingVersioner2;
...
class Versioniser2 implements VersioniserInterface
{
    ...
    public function __construct(UnimportedListingVersioner2 $entityVersioner)
    {

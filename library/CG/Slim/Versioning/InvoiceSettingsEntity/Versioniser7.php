...
class Versioniser7 implements VersioniserInterface
{
    ...
    public function upgradeRequest(array $params, Hal $request)
    {
        ...
        if (!isset($data['id']) || isset($data['useVerifiedEmailAddressForAmazonInvoices'])) {
            return;
        }
        ...
        try {
            ...
            $data['useVerifiedEmailAddressForAmazonInvoices'] = $invoiceSetting->getUseVerifiedEmailAddressForAmazonInvoices();
            $request->setData($data);
        } catch (NotFound $exception) {
            // New setting so there won't be a previously set useVerifiedEmailAddressForAmazonInvoices setting
        }
    }
    ...
    public function downgradeResponse(array $params, Hal $response, $requestedVersion)
    {
        ...
        unset($data['useVerifiedEmailAddressForAmazonInvoices']);

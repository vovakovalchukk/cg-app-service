...
CREATE TABLE `order` (
  ...
  `billingAddressId` varchar(40) NOT NULL,
  `shippingAddressId` varchar(40) NOT NULL,
  `batch` int(10) unsigned DEFAULT NULL,
  `paymentMethod` varchar(120) DEFAULT NULL,
  `paymentReference` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `order_shippingAddressId` (`shippingAddressId`),
  KEY `order_billingAddressId` (`billingAddressId`),
  CONSTRAINT `order_billingAddressId` FOREIGN KEY (`billingAddressId`) REFERENCES `address` (`id`),
  CONSTRAINT `order_shippingAddressId` FOREIGN KEY (`shippingAddressId`) REFERENCES `address` (`id`)
...
INSERT INTO `address` (`id`, `addressCompanyName`, `addressFullName`, `address1`, `address2`, `address3`, `addressCity`, `addressCounty`, `addressCountry`, `addressPostcode`, `emailAddress`, `phoneNumber`, `addressCountryCode`) VALUES (3, 'Company Name 2', 'Full Name 2', 'address 1 - 2', 'address 2 - 2', 'address 3 - 2', 'City2', 'County2', 'UK', 'Postcode2', 'emailaddress2@channelgrabber.com', '01942673432', 'GB');
INSERT INTO `address` (`id`, `addressCompanyName`, `addressFullName`, `address1`, `address2`, `address3`, `addressCity`, `addressCounty`, `addressCountry`, `addressPostcode`, `emailAddress`, `phoneNumber`, `addressCountryCode`) VALUES (4, 'Shipping Company Name 2', 'Full Name 2', 'shipping address 1 - 2', 'shipping address 2 - 2', 'shipping address 3 - 2', 'shipping City 2', 'Shipping County 2', 'UK', 'shipPostcode2', 'shippingemail2@channelgrabber.com', '07415878962', 'GB');
...
INSERT INTO `address` (`id`, `addressCompanyName`, `addressFullName`, `address1`, `address2`, `address3`, `addressCity`, `addressCounty`, `addressCountry`, `addressPostcode`, `emailAddress`, `phoneNumber`, `addressCountryCode`) VALUES (7, 'Company Name 4', 'Full Name 4', 'address 1 - 4', 'address 2 - 4', 'address 3 - 4', 'City4', 'County4', 'UK', 'Postcode4', 'emailaddress4@channelgrabber.com', '01942673434', 'GB');
INSERT INTO `address` (`id`, `addressCompanyName`, `addressFullName`, `address1`, `address2`, `address3`, `addressCity`, `addressCounty`, `addressCountry`, `addressPostcode`, `emailAddress`, `phoneNumber`, `addressCountryCode`) VALUES (8, 'Shipping Company Name 4', 'Full Name 4', 'shipping address 1 - 4', 'shipping address 2 - 4', 'shipping address 3 - 4', 'shipping City 4', 'Shipping County 4', 'UK', 'shipPostcode4', 'shippingemail4@channelgrabber.com', '07415878964', 'GB');
...
INSERT INTO `address` (`id`, `addressCompanyName`, `addressFullName`, `address1`, `address2`, `address3`, `addressCity`, `addressCounty`, `addressCountry`, `addressPostcode`, `emailAddress`, `phoneNumber`, `addressCountryCode`) VALUES (9, 'Company Name 5', 'Full Name 5', 'address 1 - 5', 'address 2 - 5', 'address 3 - 5', 'City5', 'County5', 'France', 'Postcode5', 'emailaddress5@channelgrabber.com', '01942673435', 'FR');

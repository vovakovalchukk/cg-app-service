...
class TestDataUnimportedListing extends TestMigration
{
    ...
    protected function getUnimportedListingData()
    {
        return [
            ...
            [2, 1, 2, 'anExternalID2', 'anSKU2', 'aTitle2', 'www.reddit.com', 2, '2014-08-14 14:00:00', 'lost', 1],
            [3, 1, 2, 'anExternalID3', 'anSKU3', 'aTitle3', 'www.bbc.co.uk', 3, '2014-08-16 14:00:00', 'closed', 1],
            [4, 2, 2, 'anExternalID4', 'anSKU4', 'aTitle4', 'www.sky.com', 1, '2014-08-17 14:00:00', 'lost', 3],
            [5, 2, 3, 'anExternalID5', 'anSKU5', 'aTitle5', 'www.gamerscripts.com', 3, '2015-08-20 14:00:00', 'theFuture', 10]
        ];
    }
}